...
tl.from(".logo", { opacity: 0, y: -10 }, 1)
  .from(".hamburger", { opacity: 0, x: 20 }, 1)
  .from(".hero-img", { opacity: 0, x: -200 }, 1)
  .from(".hero-content h2", { opacity: 0, y: -50 }, 1)
  .from(".hero-content h1", { opacity: 0, y: -45 }, 1)
  .from(".hero-content a", { opacity: 0, y: 50 }, 1);
